      ...
      <section>
        ...
        <ol>
          ...
          <li>
            ...
            <ol>
              <li>
                If so, that means that you've entered an
                <strong>ongoing story</strong>. Read the last sentence and write
                down your three sentences to add to the story.
              </li>
              <li>
                If there are no chunks to be seen, start a new story by simply
                writing down three sentences.
              </li>
            </ol>
          </li>
